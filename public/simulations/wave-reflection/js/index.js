...
function preload() {
    ...
    fixedPanel = loadImage("https://live.staticflickr.com/65535/51773568681_2584fa3ed2_o.png");
    freePanel = loadImage("https://live.staticflickr.com/65535/51774212474_10b8bb1e3c_o.png");
}
...
function setup() {
    ...
    fixedPanel.resize(width / 5, 0);
    freePanel.resize(width / 5, 0);
    clickedCount = true;
    fixedCount = true;
